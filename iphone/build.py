...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.ciliara.GoogleConversionTracking.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComCiliaraGoogleConversionTrackingModuleAssets.m')
